...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    OSL(9),         OSL(3),         OSL(2),         OSL(2),         OSL(1),         LSFT_T(KC_APPLICATION),                                                                                                RSFT_T(KC_ESCAPE),OSL(1),         OSL(2),         OSL(2),         OSL(3),         TO(6),          
  ...
  [2] = LAYOUT_moonlander(
    ...
    TO(9),          KC_COMMA,       HSV_0_255_255,  HSV_86_255_128, HSV_172_255_255,KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_COMMA,       KC_0,           KC_DOT,         KC_EQUAL,       KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
