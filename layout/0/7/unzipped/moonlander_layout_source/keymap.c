...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    OSL(5),         KC_J,           KC_C,           KC_Y,           KC_F,           KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_Z,           KC_L,           KC_COMMA,       KC_U,           KC_Q,           KC_EQUAL,       
    OSL(4),         KC_R,           KC_S,           KC_T,           KC_H,           KC_D,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           KC_N,           KC_A,           KC_I,           KC_O,           KC_QUOTE,       
    TT(0),          KC_SLASH,       KC_V,           KC_G,           KC_P,           KC_B,                                           KC_X,           KC_W,           KC_DOT,         KC_SCOLON,      KC_MINUS,       TT(0),          
    TO(9),          OSL(3),         OSL(2),         OSL(2),         OSL(1),         LSFT_T(KC_APPLICATION),                                                                                                RSFT_T(KC_ESCAPE),OSL(1),         OSL(2),         OSL(2),         OSL(3),         TO(6),          
    KC_SPACE,       LM(1,MOD_RGUI), LCTL_T(KC_BSPACE),                LALT_T(KC_TAB), LT(2,KC_ENTER), RALT_T(KC_E)
  ),
  [1] = LAYOUT_moonlander(
    ...
    LT(9,KC_GRAVE), WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,       KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(2),          
  ...
  [2] = LAYOUT_moonlander(
    ...
    TO(9),          KC_COMMA,       HSV_0_255_255,  HSV_86_255_128, HSV_172_255_255,KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_COMMA,       KC_DOT,         KC_0,           KC_EQUAL,       KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [3] = LAYOUT_moonlander(
  ...
  [5] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, MOON_LED_LEVEL, RGB_SPD,        RGB_SPI,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, DYN_MACRO_PLAY2,DYN_REC_START2, DYN_REC_STOP,   KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, TO(8),          TO(6),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, TO(3),          TO(4),          TO(5),          KC_TRANSPARENT, KC_TRANSPARENT, 
