...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    OSL(7),         KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSLASH,      
    OSL(6),         KC_J,           KC_C,           KC_Y,           KC_F,           KC_K,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_Z,           KC_L,           KC_COMMA,       KC_U,           KC_Q,           KC_EQUAL,       
    OSL(5),         KC_R,           KC_S,           KC_T,           KC_H,           KC_D,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           KC_N,           KC_A,           KC_I,           KC_O,           KC_QUOTE,       
    TT(0),          KC_SLASH,       KC_V,           KC_G,           KC_P,           KC_B,                                           KC_X,           KC_W,           KC_DOT,         KC_SCOLON,      KC_MINUS,       TT(0),          
    TO(9),          OSL(4),         OSL(3),         OSL(2),         OSL(1),         LSFT_T(KC_APPLICATION),                                                                                                RSFT_T(KC_ESCAPE),OSL(1),         OSL(2),         OSL(3),         OSL(4),         TO(8),          
    KC_SPACE,       LM(1,MOD_RGUI), LCTL_T(KC_BSPACE),                LALT_T(KC_TAB), LT(3,KC_ENTER), RALT_T(KC_E)
  ),
  [1] = LAYOUT_moonlander(
    ...
    LT(9,KC_GRAVE), WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,       KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(3),          
