...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LALT,        LCTL_T(KC_BSPACE),SH_MON,                    SH_MON,    TD(DANCE_0),    LT(2,KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_MS_ACCEL2,   TD(DANCE_2),    KC_WWW_BACK,    KC_WWW_HOME,    KC_WWW_FORWARD, KC_BSPACE,                                      WEBUSB_PAIR,    KC_MS_WH_LEFT,  KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, KC_AUDIO_VOL_DOWN,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
