...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, OSL(5),         KC_RALT,        OSL(3),         TD(DANCE_0),                                                                                                    RSFT_T(KC_TAB), OSL(3),         KC_RALT,        OSL(5),         KC_TRANSPARENT, KC_TRANSPARENT, 
    TD(DANCE_1),    LCTL_T(KC_BSPACE),KC_LANG3,                       KC_TRANSPARENT, TD(DANCE_2),    LT(2,KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
