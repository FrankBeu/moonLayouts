...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TD(DANCE_0),    LCTL_T(KC_BSPACE),KC_TRANSPARENT,                 KC_TRANSPARENT, TD(DANCE_1),    LT(2,KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_SPACE,       KC_RGUI,        LALT_T(KC_TAB),                 TD(DANCE_2),    LT(2,KC_ENTER), RALT_T(KC_E)
  ),
  [2] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_DQUO,        KC_EXLM,        KC_AT,          KC_LCBR,        KC_RCBR,        KC_AMPR,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_SCOLON,      KC_7,           KC_8,           KC_9,           KC_0,           KC_ASTR,        
    KC_QUOTE,       KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_TILD,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_MINUS,       KC_4,           KC_5,           KC_6,           KC_DOT,         KC_PLUS,        
    KC_GRAVE,       KC_PERC,        KC_CIRC,        KC_LBRACKET,    KC_RBRACKET,    KC_NONUS_BSLASH,                                KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_COMMA,       KC_SLASH,       
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_MS_ACCEL2,   KC_PSCREEN,     KC_WWW_BACK,    KC_WWW_HOME,    KC_WWW_FORWARD, KC_APPLICATION,                                 WEBUSB_PAIR,    KC_MS_WH_LEFT,  KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_WH_RIGHT, KC_AUDIO_VOL_DOWN,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [4] = LAYOUT_moonlander(
