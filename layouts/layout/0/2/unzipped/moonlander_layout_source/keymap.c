...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    TO(9),          TT(1),          TT(2),          TT(3),          TT(4),          KC_ESCAPE,                                                                                                      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    LSFT_T(KC_SPACE),LM(1,MOD_RGUI), MT(MOD_HYPR, KC_BSPACE),                LALT_T(KC_TAB), RCTL_T(KC_ENTER),RALT_T(KC_E)
  ),
  [1] = LAYOUT_moonlander(
    ...
    LT(9,KC_GRAVE), WEBUSB_PAIR,    LALT(KC_LSHIFT),KC_LEFT,        KC_RIGHT,       LALT_T(KC_APPLICATION),                                                                                                LCTL_T(KC_ESCAPE),KC_UP,          KC_DOWN,        KC_LBRACKET,    KC_RBRACKET,    MO(3),          
    KC_SPACE,       KC_TRANSPARENT, KC_LGUI,                        KC_LALT,        KC_TAB,         KC_ENTER
  ),
  [2] = LAYOUT_moonlander(
    KC_EQUAL,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_LEFT,                                        KC_RIGHT,       KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_MINUS,       
